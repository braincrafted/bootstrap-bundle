        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('assets_dir')
                    ->defaultValue('%kernel.root_dir%/../vendor/twbs/bootstrap-sass/vendor/assets/stylesheets/')
                ->end()
                ...
                ->arrayNode('customize')
                    ...
                    ->children()
                        ->scalarNode('variables_file')
                            ->defaultValue('%kernel.root_dir%/../vendor/twbs/bootstrap-sass/vendor/assets/stylesheets/bootstrap/variables')
                        ->end()
